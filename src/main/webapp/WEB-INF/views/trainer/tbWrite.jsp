					...
					<div class="nav-inner">
						<nav class="navbar navbar-expand-lg">
							<a class="navbar-brand" href="main_index.html"> <img
								src="../assets/images/logo/로고_2.png" alt="logo">
							</a>
							...
							<div class="row">
								...
								<div class="time">
									<div class="form-group" id="time1">
										<strong>일요일</strong>
										<div>
											<input type="time" name="time1" id="time1" value=""
												style="width: 300px;">
												<strong> ~ </strong> 
								...
								<div class="tr_options">
									<div class="btn-group-toggle" data-toggle="buttons">
										...
										<label class="btn btn-outline-secondary"
											...
											<input type="checkbox" id='tr_op' name='tr_options' value="">
											<p>홈짐방문</p>
										</label> 
										<label class="btn btn-outline-secondary"
											style="margin: 5px 10px 5px 0px; padding: 0px 15px 0px 15px;">
								...
								<div class="col-lg-6 col-12">
									...
									<div>
										<input type="file" id="img_upload" name="Photo"
									...
									<div>
										<input type="file" id="img_upload" multiple="multiple"
											name="file" accept="image/*" style="margin-bottom: 30px;">
										<div id="image_container"></div>
									</div>
								</div>
