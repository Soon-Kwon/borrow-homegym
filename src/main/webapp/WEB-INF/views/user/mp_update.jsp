                        ...
                        <nav class="navbar navbar-expand-lg">
                            ...
                            <div class="collapse navbar-collapse sub-menu-bar" id="navbarSupportedContent">
                                <ul id="nav" class="navbar-nav ms-auto">
                                    ...
                                    <li class="nav-item"><a href="../Template Main/mypage_main.html">
                                            <h5>아이유님</h5>
                                        </a></li>
                    ...
                    <div class="course-sidebar">
                        ...
                        <div class="sidebar-widget other-course-wedget">
                            ...
                            <div class="sidebar-widget-content">
                                <ul class="sidebar-widget-course" style="min-height: 30px;">
                                    ...
                                    <li class="single-course">
                                        <div class="info">
                                            <h6 class="title"><a href="course-details.html">나의 활동내역</a></h6>
                                        </div>
                                    </li>
                                    <li class="single-course">
                                        <div class="info">
                                ...
                                <div class="row">
                                    <div class="col-lg-15 " style="margin-left: 280px;">
                                        ...
                                        <div class="single-feature" style="padding: 20px">
                                            <img src="../Template Main/assets/images/mypage/2.jpg"
